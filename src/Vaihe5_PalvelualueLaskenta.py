...
elif "Hierarkia" in NDparams and Details == "2" and ArcVersio == "10.0": #Jos hierarkiaa käytetään ei voida käyttää Detailed Polygoneja ArcGIS 10.1/10.2!
    Details = "DETAILED_POLYS"
elif Details == "3":
    Details = "NO_POLYS"
else:
...
if "Hierarkia" in NDparams and ArcVersio != "10.0": #Jos hierarkiaa käytetään ei voida käyttää Trimmiä
    Trim = "NO_TRIM_POLYS"
elif Trim == "False":
    Trim = "NO_TRIM_POLYS"
elif Trim == "True":
